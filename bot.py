...
# Замок мʼякий: спершу цінність каналу, на другий натиск без підписки файл
# іде все одно (слово Yaro 14.09: «жорстко змушувати відлякає»).
LOCK_TEXT = (
    "Схеми лежать у каналі «Iryna Rul | для своїх» ♥️\n\n"
    "Там я показую те, що зазвичай не показують: як насправді ставлю світло "
    "на зйомці, що роблю, коли схема не спрацювала, ретуш до і після. "
    "Без теорії заради теорії, кожен пост можна повторити на студії того ж дня.\n\n"
    "Підпишіться і тисніть «Я в каналі», файл прийде одразу."
)
LOCK_SOFT = (
    "Не бачу вас у каналі, але файл усе одно ваш ♥️\n"
